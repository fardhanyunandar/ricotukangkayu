        ...
        <div className="about-main-content">
          ...
          <div className="about-story">
            <p className="story-paragraph">
              Gr_int Furniture Build didirikan sejak tahun 2015 oleh <strong>Rico Aris Sunaryo, S.T.</strong>, seorang pengrajin kayu berpengalaman yang mencintai setiap detail dalam proses pembuatan furniture. Kami percaya bahwa furniture yang baik bukan hanya soal fungsi — tapi juga cerita dan karakter.
            </p>
            <p className="story-paragraph story-paragraph--en" lang="en">
              Gr_int Furniture Build was founded in 2015 by Rico Aris Sunaryo, S.T., an experienced woodworker who loves every detail in the furniture-making process. We believe that good furniture is not just about function — it's also about story and character.
            </p>
            <p className="story-paragraph">
            ...
            <div className="profile-card-inner">
              <div className="profile-meta-row">
                ...
                <div className="profile-info">
                  <h3 className="profile-name">Rico Aris Sunaryo, S.T.</h3>
